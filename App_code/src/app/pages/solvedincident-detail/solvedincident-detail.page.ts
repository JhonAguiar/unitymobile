...
@Component({
  selector: 'app-solvedincident-detail',
  templateUrl: './solvedincident-detail.page.html',
  styleUrls: ['./solvedincident-detail.page.scss'],
})
export class SolvedincidentDetailPage implements OnInit {
